...
/**
 * Represents the CorePrioritizationFirstFit2 component.
 */
public class CorePrioritizationFirstFit2 implements CoreAndSpectrumAssignmentAlgorithmInterface{
	...
	/**
	 * Creates a new instance of CorePrioritizationFirstFit2.
	 */
	public CorePrioritizationFirstFit2(){
...
//	}
	...
	private void imprimeLog(Circuit circuit) {
		...
		System.out.println("Crosstalk on this optical path: "+circuit.getXt());
	}
}
