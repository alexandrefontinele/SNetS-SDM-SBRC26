...
/**
 * Represents the IncrementalCoreFirstFitv2 component.
 */
public class IncrementalCoreFirstFitv2 implements CoreAndSpectrumAssignmentAlgorithmInterface{
	...
	/**
	 * Creates a new instance of IncrementalCoreFirstFitv2.
	 */
	...
	public boolean assignCoreAndSpectrum(int numberOfSlots, Circuit circuit, ControlPlane cp) {
		...
		//System.out.println("The selected core is: "+chosenCore);
