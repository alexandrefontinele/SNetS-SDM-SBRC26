...
public class ModulationSelector {
	...
	public static List<Modulation> configureModulations(Mesh mesh){
		double freqSlot = mesh.getLinkList().get(0).getCore(0).getSlotSpectrumBand();
		...
		// String name, double maxRange, double M, double SNRthreshold, double rateFEC, double freqSlot, double p, double XTthreshold
		avaliableModulations.add(new Modulation("BPSK", 10000.0, 2.0, 5.5, rateFEC, freqSlot, p, -14.0));
		avaliableModulations.add(new Modulation("QPSK", 5000.0, 4.0, 8.5, rateFEC, freqSlot, p, -18.5));
		avaliableModulations.add(new Modulation("8QAM", 2500.0, 8.0, 12.5, rateFEC, freqSlot, p, -21.0));
		avaliableModulations.add(new Modulation("16QAM", 1250.0, 16.0, 15.1, rateFEC, freqSlot, p, -25.0));
		avaliableModulations.add(new Modulation("32QAM", 625.0, 32.0, 18.1, rateFEC, freqSlot, p, -27.0));
		avaliableModulations.add(new Modulation("64QAM", 312.0, 64.0, 21.1, rateFEC, freqSlot, p, -34.0));
