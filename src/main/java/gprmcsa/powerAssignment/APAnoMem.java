...
/**
 * This class represents the Adaptive Power Assignment without memory (APAnoMem) algorithm.
 ...
 * @author Alexandre
 */
public class APAnoMem implements PowerAssignmentAlgorithmInterface {
	...
	public double assignLaunchPower(Circuit circuit, Route route, Modulation modulation, int core, int[] spectrumAssigned, ControlPlane cp) {
		...
		double launchPower = AdaptivePowerAssignmentWithoutMemory(circuit, route, modulation, core, spectrumAssigned, cp);
	...
	/**
	 * This method applies the APAnoMem power assignment strategy.
	 *
	 ...
	 * @return double
	 */
    public double AdaptivePowerAssignmentWithoutMemory(Circuit circuit, Route route, Modulation mod, int core, int sa[], ControlPlane cp){
